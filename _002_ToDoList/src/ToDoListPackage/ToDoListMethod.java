...
public class ToDoListMethod {
    ...
    public void removePreviousItemMethod() {
        ...
        switch (userChoice) {
            case 1:
                ...
                highPriorityPersonal.remove(delete);
                break;
            case 2:
                delete = personalList.size();
                personalList.remove(delete);
                break;
            case 3:
                delete = highPriorityGroceryList.size();
                highPriorityGroceryList.remove(delete);
                break;
            case 4:
                delete = groceryList.size();
                groceryList.remove(delete);
                break;
            case 5:
                quitMethod();
                break;
    ...
    public void displayHelpMethod() {
        System.out.println("Type out help explanation");
    }
